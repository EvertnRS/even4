package br.upe.ui.fx.mediator.session;

import br.upe.ui.fx.mediator.Mediator;
import br.upe.ui.fx.screen.session.SessionScreenController;
...
public class SessionMediator extends Mediator {
    ...
    private String getFxmlPathForEvent(String event) {
        return switch (event) {
            ...
            case HANDLE_SESSION, HANDLE_BACK -> "/fxml/allSessionsScreen.fxml";
